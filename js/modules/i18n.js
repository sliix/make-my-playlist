...
export const translations = {
  en: {
    ...
    "alert.spotifyAuthFailed": "Could not authorize Spotify account: {error}",
    ...
    "alert.confirmDisconnectService": "Are you sure you want to disconnect from {service}?",
    "alert.resolvingTracksProgress": "Resolving track {current} of {total} on {service}...",
    "alert.resolvingTracksFailed": "Failed to resolve some tracks on the new service.",
  ...
  he: {
    ...
    "alert.spotifyAuthFailed": "אימות חשבון ספוטיפיי נכשל: {error}",
    ...
    "alert.confirmDisconnectService": "האם אתה בטוח שברצונך להתנתק מ-{service}?",
    "alert.resolvingTracksProgress": "מאתר שיר {current} מתוך {total} ב-{service}...",
    "alert.resolvingTracksFailed": "איתור חלק מהשירים בשירות החדש נכשל.",
